...
with_node \
  ...
  --target "/Users/robin/projects/cvsqure-mobile/ios/Pods/Target Support Files/Pods-cvsquremobile/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "@react-native-google-signin/google-signin" "expo-application" "expo-asset" "expo-constants" "expo-crypto" "expo-file-system" "expo-font" "expo-keep-awake" "expo-router" "expo-secure-store" "expo-system-ui" "expo-web-browser"
